export const projects = [
  ...
  {
    title: 'Fighting game',
    description: "A simple fighting game made in JS using HTML Canvas. Currently with 2 game modes: Player vs AI and Player vs Player.",
    image: '/images/2.png',
  ...
  },
  {
    ...
    description: "Space invaders like game made in Python",
    image: '/images/3.png',
    tags: ['Python', 'Pygame'],
